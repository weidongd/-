(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/HelloWorld2.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1e496p1FnZPcqkrbd5/vpMX', 'HelloWorld2', __filename);
// Script/HelloWorld2.js
...
cc.Class({
    ...
    __startPoker: function __startPoker() {
    ...
    __endPoker: function __endPoker() {
        var self = this;
        setTimeout(function () {
            self.__removeRes();
        }, 1000);
    ...
    __intMoveProgram: function __intMoveProgram(glProgram, isUpDown) {
    ...
    __intSmoothProgram: function __intSmoothProgram(glProgram) {
        glProgram.rotationLc = glProgram.getUniformLocation("rotation");
        glProgram.offx = glProgram.getUniformLocation("offx");
        glProgram.offy = glProgram.getUniformLocation("offy");
        glProgram.Height = glProgram.getUniformLocation("height");
    ...
    __initTexAndPos: function __initTexAndPos(isBack, isLeftRight) {
    ...
    __deleteBuff: function __deleteBuff(buffInfo) {
        gl._deleteBuffer(buffInfo[0]);
        gl._deleteBuffer(buffInfo[1]);
    },

    //结束需要移除
    __removeRes: function __removeRes() {
